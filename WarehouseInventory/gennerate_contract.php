...
{
    global $db;
    $sql = "select supplier_id as id, count(1) number, s.name as supplier_name from requestion_details as a
            left join supplier as s on a.supplier_id=s.id where a.supplier_id!=0
            group by supplier_id order by s.name";


     $sql = "select s.id, s.name as supplier_name, count(1) as number from requestion_details as a
                left join supplier as s on a.supplier_id=s.id 
                left join contract_entry_details as cd on a.id=cd.requestion_details_id and cd.supplier_id=s.id
                where a.supplier_id!=0 and cd.id is null
...
<script type="text/javascript">
    ...
    var g_supplier_id = 0;
    var ds = '<?php $user_id = $_SESSION['user_id']; $requestion_infos = get_supplier_product(); echo str_replace('"', '"', json_encode($requestion_infos)); ?>';
    ...
    function showDetails(requestion_detail_id, supplier_name) {
        ...
        $.ajax({
            type: "GET",
            url: "gennerate_contract_server.php",//请求的后台地址
            data: "supplier_id=" + requestion_detail_id,//前台传给后台的参数
            ...
            <div class="panel-body">
                ...
                <table id="example" class="table table-bordered table-hover" data-height="750" data-unique-id="id"
                    ...
                    <tr>
                        ...
                        <th class="text-center" data-field="number" data-sortable="true">请购项目数</th>
                    </tr>
                    </thead>
        ...
        <div class="panel-body">
            ...
            <table align="center" data-height="750" id="tb_details" data-click-to-select="true" data-toolbar="#toolbar" data-unique-id="id">
                ...
                <tr>
                    ...
                    <th data-class="text-center" data-field="code" data-title="请购单号"></th>
                    ...
                    <th data-class="text-center" data-field="godown_info" data-title="到货数量"></th>
