...
page_require_level("70002");


//$all_groups = find_all('rule');
$all_groups = find_by_sql("SELECT * FROM rule order by code");
                ...
                <table class="table table-bordered" align="center" id="example">
                    ...
                    <?php foreach ($all_groups as $a_group): ?>
                        <tr>
                            ...
                            <td class="text-center">
                                <div class="btn-group">
                                    <a href="edit_rule.php?id=<?php echo (int)$a_group['id']; ?>"
                                       class="btn btn-xs btn-warning" data-toggle="tooltip" title="Edit">
                                        <i class="glyphicon glyphicon-pencil"></i>
                                    </a>
                                    <a href="rule.php?remove=1&id=<?php echo (int)$a_group['id']; ?>"
