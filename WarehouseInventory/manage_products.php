            ...
            <div class="panel-body">
                ...
                <table id="example" class="table table-bordered table-hover" data-height="750" data-unique-id="id"
                    ...
                    <tr>
                        ...
                        <th class="text-center" data-switchable="false" data-visible="true" data-field="name">名称</th>
                        <th class="text-center" data-sortable="true" data-field="spcification">规格</th>
                        <th class="text-center" data-sortable="true" data-field="model_number">型号</th>
...
<script type="text/javascript">
    ...
    {
        return "hello";
        /*return '<a href="edit_group.php?id=4" class="btn btn-xs btn-warning" data-toggle="tooltip" title="Edit"> \
        <i class="glyphicon glyphicon-pencil"></i> \
        </a> \
        <a href="delete_group.php?id=4" class="btn btn-xs btn-danger" data-toggle="tooltip" title="Remove"> \
