...
<script type="text/javascript">
    ...
    function addDetails() {
        ...
        jsonData['project_name'] = encodeURI($("#data_project").find("option:selected").text());
        jsonData['project_id'] = $("#data_project").val();
        jsonData['product_name'] = encodeURI($("#product_name_info_list").val());
        jsonData['specification_name'] = encodeURI($("#product_input_specification_list").val());
        jsonData['modelnumber_name'] = encodeURI($("#product_input_modelnumber_list").val());
        jsonData['product_number'] = $("#data_product_number").val();
        jsonData['unit'] = $("#data_product_unit").text();
        jsonData['type'] = $("#data_product_type").val();
        jsonData['type_name'] = encodeURI($("#data_product_type").find("option:selected").text());///物料类别
        jsonData['product_code'] = $("#data_product_code").val();
        jsonData['qualification_name'] = encodeURI($("#data_product_qualification").find("option:selected").text());//资质要求
        jsonData['qualification_id'] = $("#data_product_qualification").val();
        jsonData['reference'] = encodeURI($("#data_product_reference").val());//物料参考资源
        ...
        jsonData['memo'] = encodeURI($("#data_product_memo").val());//备注
