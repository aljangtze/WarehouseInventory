...
CREATE TABLE `godown_entry` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 COMMENT='入库单';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `godown_entry` VALUES (6,'RK201808280005',0,2,'2018-08-28 11:42:27',8),(7,'RK201808280006',0,1,'2018-08-28 11:43:10',8),(8,'RK201808280007',0,2,'2018-08-28 11:43:31',8);
...
INSERT INTO `godown_entry_code` VALUES (2018,8,1,0,''),(2018,8,1,1,'RK201808010001'),(2018,8,7,2,'RK201808070002'),(2018,8,28,3,'RK201808280003'),(2018,8,28,4,'RK201808280004'),(2018,8,28,5,'RK201808280005'),(2018,8,28,6,'RK201808280006'),(2018,8,28,7,'RK201808280007');
...
CREATE TABLE `godown_entry_details` (
  ...
  `date` datetime DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8 COMMENT='入库单详情';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `godown_entry_details` VALUES (7,6,2,0,0,1,'','2018-08-28 11:42:27'),(8,7,1,0,0,2,'','2018-08-28 11:43:10'),(9,8,1,0,0,1,'','2018-08-28 11:43:31');
...
INSERT INTO `outgoing_entry_code` VALUES (2018,'0','0',0,'000');
...
) ENGINE=InnoDB AUTO_INCREMENT=1510 DEFAULT CHARSET=utf8 COMMENT='产品表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `role` VALUES (3,'采购人员','拥有请购单状态更新，出入库，库存状态查看权限',1),(32,'提交请购单','提交请购单',1),(33,'新增加','新增加',1);
...
INSERT INTO `role_rules` VALUES (37,3,1),(38,3,2),(43,33,1),(44,33,2);
...
INSERT INTO `users` VALUES (8,'廖长江','Admin','d033e22ae348aeb5660fc2140aec35850c4da997',1,'no_image.jpg',1,'2018-08-28 09:28:29'),(9,'张慧','zhanghui','6c7ca345f63f835cb353ff15bd6c5e052ec08e7a',1,'no_image.jpg',1,'2018-07-24 14:17:45');
...
-- Dump completed on 2018-08-29 13:51:22
